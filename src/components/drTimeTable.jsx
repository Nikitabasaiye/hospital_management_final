          ...
          <div className="col-12 mt-4 pt-2">
            <div className="table-responsive shadow rounded">
              <table className="table table-center table-bordered bg-white mb-0">
                ...
                <tbody>
                  <tr>
                    <th className="text-center py-5"> 09: 00 AM </th>{" "}
                    <td>
                  ...
                  <tr>
                    <th className="text-center py-5"> 11: 00 AM </th> <td> </td>{" "}
                    <td>
                      <div className="d-flex mb-3">
                        <img
                          src={dr3}
                  ...
                  <tr>
                    <th className="text-center py-5"> 02: 00 PM </th> <td> </td>{" "}
                    <td> </td>{" "}
                    <td>
                      <div className="d-flex mb-3">
                        <img
                  ...
                  <tr>
                    <th className="text-center py-5"> 04: 00 PM </th> <td> </td>{" "}
                    <td> </td> <td> </td>{" "}
                    <td>
                      <div className="d-flex mb-3">
                        <img
                  ...
                  <tr>
                    <th className="text-center py-5"> 06: 00 PM </th>{" "}
                    <td>
                      <div className="d-flex mb-3">
                        <img
                          src={dr10}
                  ...
                  <tr>
                    <th className="text-center py-5"> 09: 00 PM </th> <td> </td>{" "}
                    <td>
                      <div className="d-flex mb-3">
                        <img
                          src={dr4}
