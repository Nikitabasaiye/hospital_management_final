            ...
            <div className="col-12">
              <div className="heading-title">
                ...
                <div className="mt-4 pt-2">
                  <Link to="/booking-appointment" className="btn btn-primary">
              ...
              <div className="ms-lg-4">
                <div className="section-title">
                  ...
                  <p className="text-muted para-desc mb-0">
                    ...
                    is said to have originated in the 16 th century.Lorem Ipsum
                ...
                <div className="mt-4">
                  <Link to="/aboutus" className="btn btn-primary">
                    ...
                    Read More <RiArrowRightLine className="align-middle" />
                  </Link>
                </div>
              </div>
            </div>
                ...
                <div className="col-xl-3 col-md-4 col-12 mt-5" key={index}>
                  <div className="card features feature-primary border-0">
                    ...
                    <div className="card-body p-0 mt-3">
                      <Link to="/departments" className="title text-dark h5">
        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 mt-4 pt-2 text-center">
              <Link to="/doctor-team-one" className="btn btn-primary">
                  ...
                  <div className="card blog blog-primary border-0 shadow rounded overflow-hidden">
                    ...
                    <div className="card-body p-4">
                      <ul className="list-unstyled mb-2 ">
                        <li className="list-inline-item text-muted small me-3 d-inline-flex align-items-center">
                          
                          <FiCalendar className="text-dark h6 me-1 mb-0" />
                          {item.date}
                        </li>
                        <li className="list-inline-item text-muted small d-inline-flex align-items-center">
                          
                          <FiClock className="text-dark h6 me-1 mb-0 " />
                          {item.time}
                        </li>
                      </ul>
                      <Link
                      ...
                      <div className="post-meta d-flex justify-content-between mt-3">
                        ...
                        <Link to={`/blog-detail/${item.id}`} className="link">
