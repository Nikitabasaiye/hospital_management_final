...
export default function Faqs() {
    return (
        <>
            {/* <Navigation manuClass="navigation-menu nav-light nav-left" containerClass="container" /> */}
                    ...
                    <div className="row mt-5 justify-content-center">
                        <div className="col-12">
                            ...
                            <div className="subcribe-form text-center mt-4">
                                <form>
                                    <input type="text" id="name" name="name" className="border bg-white-50 rounded-pill" required placeholder="Ask a question..." />
                                    <button type="submit" className="btn btn-pills btn-primary">
                                        <RiSearchLine className="mb-0 align-middle me-1" /> Search
                                    </button>
                                </form>
                                    ...
                                    <div className="card features feature-primary text-center border-0">
                                        ...
                                        <div className="card-body p-0 mt-3">
                                            ...
                                            <Link to="#" className="link">
                                                Read More <FiArrowRight className="mb-0 align-middle" />
                                            </Link>
                                        </div>
                                    </div>
                                </div>
