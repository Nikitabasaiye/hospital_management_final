                  ...
                  <div className="card border-0 rounded shadow">
                        ...
                        >
                          <Link className="dropdown-item text-dark" to="#">
                            ...
                            <span className="mb-0 d-inline-block me-1">
                              {" "}
                              <MdOutlineLibraryAdd className="align-middle h6 mb-0" />{" "}
                            </span>{" "}
                            Add New
                          </Link>
                          <Link className="dropdown-item text-dark" to="#">
                    ...
                    >
                      ...
                      {appointment.map((item, index) => {
                        ...
                        return (
                          <div
                            className="d-flex justify-content-between align-items-center rounded py-1 px-3 shadow mt-3"
                            key={index}
                          >
                  ...
                  <div className="card border-0 rounded shadow">
                    ...
                    >
                      ...
                      {paymentTwo.map((item, index) => {
                        return (
                          <div
                            className="d-flex justify-content-between align-items-center rounded py-2 px-3 shadow mt-3"
                            key={index}
                          >
                      ...
                      <ul className="list-unstyled mb-0">
                        <li className="dropdown dropdown-primary list-inline-item">
                          ...
                          >
                            ...
                            <Link
                              className="dropdown-item text-dark my-2"
                              to="#"
                            >
                              {" "}
                              <span className="mb-0 d-inline-block me-1">
                            ...
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 59 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 45 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 44 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 42 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 40 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 35 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 25 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-inline-block">
                            <div className="d-flex chat-type mb-3">
                              ...
                              >
                                ...
                                <small className="text-muted msg-time">
                                  {" "}
                                  <FiClock className="me-1" /> 20 min ago{" "}
                                </small>
                              </div>
                            </div>
                          </div>
                        ...
                        return (
                          <div className="progress-box mt-4" key={index}>
                            ...
                            <div className="progress">
                              ...
                              >
                                <div className="progress-value d-block text-muted">
                                  {" "}
                                  {item.progress}{" "}
                                </div>
                              </div>
