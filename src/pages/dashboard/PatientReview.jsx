                    ...
                    <div className="mt-4">
                      <div className="progress-box">
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="progress-value d-block text-muted h6">5 Star</div>
                        </div>
                      ...
                      <div className="progress-box mt-4">
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="progress-value d-block text-muted h6">4 Star</div>
                        </div>
                        <div className="progress">
                          <div
                            className="progress-bar position-relative bg-primary"
                      ...
                      <div className="progress-box mt-4">
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="progress-value d-block text-muted h6">3 Star</div>
                        </div>
                        <div className="progress">
                          <div
                            className="progress-bar position-relative bg-primary"
                      ...
                      <div className="progress-box mt-4">
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="progress-value d-block text-muted h6">2 Star</div>
                        </div>
                        <div className="progress">
                          <div
                            className="progress-bar position-relative bg-primary"
                      ...
                      <div className="progress-box mt-4">
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="progress-value d-block text-muted h6">1 Star</div>
                        </div>
                        <div className="progress">
                          <div
                            className="progress-bar position-relative bg-primary"
